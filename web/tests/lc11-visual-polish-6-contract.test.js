...
[
  ...
  '.action-panel .cost{',
  'Visual-Polish VI-C: Boss-Zentrale mit klarer Lage-, Warn- und Wertehierarchie',
  ...
  '.legend>span{',
  '.map-commandbar{',
  'grid-template-areas:"callout quick" "targets targets"',
  '.map-callout::before{',
  'content:"LAGE"',
  '.map-direct-targets{',
  '.direct-target:hover:not(:disabled),.direct-target:focus-visible'
...
console.log('PASS: Visual-Polish VI – räumliche Kartenbühne, Spezialorte, Aktionsleiste, Boss-Zentrale, Kartenlage, Kartenleseschlüssel, Innenräume, Kampf und Reduced-Motion geprüft.');
