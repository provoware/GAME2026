...
echo '[1/23] Basis-Daten Syntax'
node --check web/data.js

echo '[2/23] Revival-/05-/06-/07-/08-Daten Syntax'
...
echo '[7/23] Basis-/Revival-UI Syntax'
node --check web/app.js
node --check web/revival-ui.js

echo '[8/23] Kern-Regression / 500 Züge'
node web/tests/engine.test.js

echo '[9/23] Revival-Regression'
node web/tests/revival-engine.test.js

echo '[10/23] LIVING-CITY-05 Regression / 1200 Züge'
node web/tests/lc05-engine.test.js

echo '[11/23] LIVING-CITY-06 Regression / 1500 Züge'
node web/tests/lc06-engine.test.js

echo '[12/23] LIVING-CITY-07 Regression / 2000 Züge'
node web/tests/lc07-engine.test.js

echo '[13/23] LIVING-CITY-08 Regression / 2500 Züge'
node web/tests/lc08-engine.test.js

echo '[14/23] Revival-Director / 1000 Züge'
node web/tests/director-simulation.test.js

echo '[15/23] UI-Smoke + finaler statischer UI-Vertrag'
node web/tests/ui-smoke.test.js
node web/tests/static-ui.test.js

echo '[16/23] Karten-/Bedien-Regression'
node web/tests/ui-regression.test.js

echo '[17/23] LIVING-CITY-05 Modul-/Visual-Vertrag'
node web/tests/lc05-contract.test.js

echo '[18/23] Revival-Modul-/Visual-Vertrag'
node web/tests/revival-contract.test.js

echo '[19/23] Chrome-/Performance-Regression'
node web/tests/performance-regression.test.js

echo '[20/23] LIVING-CITY-05B Karten-/Responsive-Vertrag'
node web/tests/lc05b-contract.test.js

echo '[21/23] LIVING-CITY-06 Führungs-/Innenraum-/Klang-/Kampf-Vertrag'
node web/tests/lc06-contract.test.js

echo '[22/23] LIVING-CITY-07 Folgeketten-/Chrome-Basisvertrag'
node web/tests/lc07-contract.test.js

echo '[23/23] LIVING-CITY-08 Stadtgedächtnis-/Journal-/Fokusvertrag + Python-Syntax'
